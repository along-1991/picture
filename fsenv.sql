...
-- ----------------------------
INSERT INTO `system_config` VALUES (1, 'app_name', '恒星在线监测平台');
INSERT INTO `system_config` VALUES (2, 'site_name', '恒星在线监测平台');
INSERT INTO `system_config` VALUES (3, 'app_version', '2.0');
INSERT INTO `system_config` VALUES (4, 'site_copy', '©版权所有 2014-2018 楚才科技');
INSERT INTO `system_config` VALUES (5, 'browser_icon', '/static/upload/75d74081294fbdba/27e5df632baa3f97.png');
INSERT INTO `system_config` VALUES (6, 'tongji_baidu_key', '');
INSERT INTO `system_config` VALUES (7, 'miitbeian', '粤ICP备15105890号-2 恒星在线监测平台');
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of system_log
-- ----------------------------
INSERT INTO `system_log` VALUES (1, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-07 16:20:44');
INSERT INTO `system_log` VALUES (2, '127.0.0.1', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-03-07 17:00:49');
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', '', '', '', 22974, '2019-03-07 16:20:43', 1, '2,4', 0, NULL, '2015-11-13 15:14:22');
